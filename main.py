...
def get_args_parser():
    ...
    parser.add_argument('--train_dataset', default=None, type=str,
                        help='Name of the training dataset to use (e.g., RainyImages)')
    parser.add_argument('--val_dataset', default=None, type=str,
                        help='Name of the validation dataset to use (e.g., RainyImages)')
    parser.add_argument('--test_dataset', default=None, type=str,
                        help='Name of the test dataset to use (e.g., Foggy_Driving_voc)')
    ...
    parser.add_argument('--use_aux_ffn', default=False, action='store_true')
...
def main(args):
    ...
    if args.eval:
        test_stats, _ = evaluate(model, criterion, postprocessors,
                                 data_loader_val, device, args.output_dir, epoch=0)
        # Standalone evaluation doesn't produce extensive logs, but you can see mAP in console
        return
